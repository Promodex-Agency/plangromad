...
<section class="edit-account page__content">
    <div class="page__container edit-account__content">
        ...
        <div class="edit-account__block">
            <div class="ur-frontend-form login ur-edit-profile" id="ur-frontend-form">
                <form class="edit-account__form user-registration-EditProfileForm edit-profile" action="" method="post" enctype="multipart/form-data">
                    <h3 class="edit-account__title">Редагування профілю</h3>
	                <?php do_action( 'user_registration_edit_profile_form_start' ); ?>
                    <div class="edit-account__form-block">
                        <div class="edit-account__row">
                            <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_first_name']['field_key']; ?>">
                                Прізвище та ім’я
                                <input class="input" data-id="user_registration_first_name" name="user_registration_first_name" id="<?php echo 'user_registration_' . $profile['user_registration_first_name']['field_key']; ?>" type="text" pattern="[А-ЯІЇЄA-Z][а-яіїєa-z]+\s[А-ЯІЇЄA-Z][а-яіїєa-z]+" placeholder="Ваше прізвище" value="<?php echo $profile['user_registration_first_name']['value']; ?>" data-required data-validate>
                            </label>
                            <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_input_box_1672854396']['field_key']; ?>">
                                Посада
                                <input class="input" data-id="user_registration_input_box_1672854396" name="user_registration_input_box_1672854396" id="<?php echo 'user_registration_' . $profile['user_registration_input_box_1672854396']['field_key']; ?>" type="text" placeholder="Ваша посада" value="<?php echo $profile['user_registration_input_box_1672854396']['value']; ?>">
                            </label>
                        </div>
                        <div class="edit-account__row">
                            <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_user_email']['field_key']; ?>">
                                Електронна пошта
                                <input class="input" data-id="user_registration_user_email" name="user_registration_user_email" id="<?php echo 'user_registration_' . $profile['user_registration_user_email']['field_key']; ?>" type="email" data-required="email" data-validate placeholder="Введіть ваш E-mail" value="<?php echo $profile['user_registration_user_email']['value']; ?>">
                            </label>
                            <div class="edit-account__row-block">
                                <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_input_phone']['field_key']; ?>">
                                    Контактний телефон
                                    <input class="input input-tel" data-id="user_registration_input_phone" name="user_registration_input_phone" id="<?php echo 'user_registration_' . $profile['user_registration_input_phone']['field_key']; ?>" type="tel" data-required placeholder="+38(___)___-__-__" data-validate pattern="^\+\d{2}\(\d{3}\)\s\d{3}[-]\d{2}[-]\d{2}$" value="<?php echo $profile['user_registration_input_phone']['value']; ?>">
                                </label>
                                <label class="registration__label edit-account__label" for="user-population">
                                    Кількість мешканців
                                    <input class="input" data-id="user_registration_input_box_number_residents" name="user_registration_input_box_number_residents" id="<?php echo 'user_registration_' . $profile['user_registration_input_box_number_residents']['field_key']; ?>" type="text" value="<?php echo $profile['user_registration_input_box_number_residents']['value']; ?>">
                                </label>
                                <label class="registration__label edit-account__label" for="user-vpo">
                                    В тому числі ВПО
                                    <input class="input" data-id="user_registration_input_box_vpo" name="user_registration_input_box_vpo" id="<?php echo 'user_registration_' . $profile['user_registration_input_box_vpo']['field_key']; ?>" type="text" value="<?php echo $profile['user_registration_input_box_vpo']['value']; ?>">
                                </label>
                            </div>
                        </div>
                        <div class="edit-account__row">
                            <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_input_city']['field_key']; ?>">
                                Область
                                <input class="input input--readonly" data-id="user_registration_input_city" name="user_registration_input_city" type="text" id="<?php echo 'user_registration_' . $profile['user_registration_input_city']['field_key']; ?>" value="<?php echo $profile['user_registration_input_city']['value']; ?>" readonly>
                            </label>
                            <div class="edit-account__row-select">
                                <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_input_area']['field_key']; ?>">
                                    Район
                                    <input class="input input--readonly" data-id="user_registration_input_area" type="text" name="user_registration_input_area" id="<?php echo 'user_registration_' . $profile['user_registration_input_area']['field_key']; ?>" value="<?php echo $profile['user_registration_input_area']['value']; ?>" readonly>
                                </label>
                                <label class="registration__label edit-account__label" for="<?php echo 'user_registration_' . $profile['user_registration_input_community']['field_key']; ?>">
                                    Громада
                                    <input class="input input--readonly" data-id="user_registration_input_community" name="user_registration_input_community" type="text" id="<?php echo 'user_registration_' . $profile['user_registration_input_community']['field_key']; ?>" value="<?php echo $profile['user_registration_input_community']['value']; ?>" readonly>
                                </label>
                            </div>
                        </div>
                    </div>
                    <h3 class="edit-account__title">Змінити пароль</h3>
                    <div class="edit-account__form-block">
                        <div class="edit-account__row">
                            <label class="registration__label edit-account__label" for="user-password">
                                Введіть новий пароль
                                <input class="input" id="user-password" type="password" placeholder="Введіть новий пароль" data-validate autocomplete="off" minlength="6">
                                <button class="form__viewpass ico-eye"></button>
                            </label>
                            <div class="edit-account__row-select">
                                <label class="registration__label edit-account__label" for="user-password">
                                    Повторіть новий пароль
                                    <input class="input" id="user-password" type="password" placeholder="Повторіть новий пароль" data-validate autocomplete="off" minlength="6">
                                    <button class="form__viewpass ico-eye"></button>
                                </label>
                            </div>
                        </div>
                    ...
                    if ( 'yes' === get_option( 'user_registration_ajax_form_submission_on_edit_profile', 'no' ) ) {
                        ?>
                        <button type="submit" class="user-registration-submit-Button btn edit-account__btn button button--green _p40 <?php echo esc_attr( implode( ' ', $submit_btn_class ) ); ?>" data-popup="#save" name="save_account_details" ><span></span><?php esc_html_e( apply_filters( 'user_registration_profile_update_button', __( 'ЗБЕРЕГТИ ЗМІНИ', 'user-registration' ) ) ); ?></button>
                        <?php
                    } else {
                        wp_nonce_field( 'save_profile_details' );
                        ?>
                        <input type="submit" class="user-registration-Button btn edit-account__btn button button--green _p40 <?php echo esc_attr( implode( ' ', $submit_btn_class ) ); ?>" name="save_account_details" value="<?php esc_attr_e( apply_filters( 'user_registration_profile_update_button', __( 'ЗБЕРЕГТИ ЗМІНИ', 'user-registration' ) ) ); ?>" />
...
<div class="ur-frontend-form login ur-edit-profile" id="ur-frontend-form" style="display: none;">
